...
Реализация полностью соответствует разработанной объектной модели из лабораторных работ по учебной дисциплине ОМИС(объектное моделирование интеллектуальных систем).
...
**Обоснование отклонений**: Проект разрабатывается как минимальный прототип для демонстрации функциональности, а не полнофункциональная система. Упрощения позволяют быстрее достичь рабочего состояния и соответствуют требованиям "даже в ущерб производительности и масштабируемости".
